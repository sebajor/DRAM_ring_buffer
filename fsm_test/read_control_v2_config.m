...
function read_control_v2_config(this_block)

  % Revision History:
  %
  %   02-Apr-2020  (19:26 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/seba/Workspace/projects/DRAM_ring_buffer/fsm_test/read_control_v2.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('read_control_v2');
  ...
  counter_port.setType('UFix_1_0');
  counter_port.useHDLVector(false);
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('read_control_v2.v');
